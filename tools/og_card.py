...
# sub-line
d.text((72, 468), "Your own race room in Gurugram.", font=sub, fill=CHALK)

# mono strip with the rig
d.text((72, 534), "GT7 · Fanatec DD Pro · Playseat Trophy · PS5 · up to 5 people", font=mono, fill=MUTED)
